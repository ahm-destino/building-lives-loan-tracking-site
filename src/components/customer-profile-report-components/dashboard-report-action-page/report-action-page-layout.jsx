    ...
    return(
        <>
            ...
            <div className="flex flex-col bg-white rounded-lg p-[20px] shadow ">
                ...
                <p className={id === "I gave Out" ? "self-start text-xs text-red-600 bg-red-500/10  p-[5px_10px] rounded-[8px] " : "self-start text-xs text-red-600 bg-green-500/10  p-[5px_10px] rounded-[8px] " }> Balance: N{amount} </p>
            </div>
